...
QT_MOC_LITERAL(6, 46, 5), // "param"
QT_MOC_LITERAL(7, 52, 7), // "timeout"
QT_MOC_LITERAL(8, 60, 7), // "onTimer"
QT_MOC_LITERAL(9, 68, 10) // "onTimer500"

    },
    "ExtProcess\0got_accept\0\0cmd\0got_done\0"
    "got_error\0param\0timeout\0onTimer\0"
    "onTimer500"
};
...
static const uint qt_meta_data_ExtProcess[] = {
 ...
 // signals: name, argc, parameters, tag, flags
       ...
       5,    1,   60,    2, 0x26 /* Public | MethodCloned */,
...
void ExtProcess::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->got_error((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 3: _t->got_error((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->timeout((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->onTimer(); break;
        case 6: _t->onTimer500(); break;
        default: ;
        }
        ...
        {
            using _t = void (ExtProcess::*)(int , int );
...
// SIGNAL 2
void ExtProcess::got_error(int _t1, int _t2)
{
