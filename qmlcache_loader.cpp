...
namespace _0x5f__Popup_test_tts_qml { 
    extern const unsigned char qmlData[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), nullptr, nullptr
    };
...
Registry::Registry() {
        ...
        resourcePathToCachedUnit.insert(QStringLiteral("/Popup_test_tts.qml"), &QmlCacheGeneratedCode::_0x5f__Popup_test_tts_qml::unit);
